            ...
            <nav className="hidden lg:flex items-center space-x-6 xl:space-x-8">
              ...
              <Link href='/contact'>
                <Button
                  variant="outline"
                  size="sm"
                  className="bg-[#6529b2] cursor-pointer ml-4 dark:bg-[#6529b2] dark:border-[#6529b2] border-[#6529b2] text-white hover:bg-[#5a24a0] hover:border-[#5a24a0]  dark:hover:bg-[#5a24a0] dark:hover:border-[#5a24a0]transition-all duration-300 font-satoshi"
                >
                  Contact Us
                </Button></Link>
            </nav>
