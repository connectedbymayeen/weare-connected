				...
				<div className='pt-2 pb-8 relative z-10'>
					<div className='container mx-auto px-4 sm:px-6 md:px-8 py-8 max-w-7xl'>
						<div className='text-center mb-12 mx-auto max-w-4xl'>
							<h1 className='text-3xl sm:text-4xl md:text-5xl font-bold text-pot-black mb-4 font-syne'>
								Our Blog
							</h1>
							<p className='text-lg sm:text-xl text-gray-600 max-w-2xl mx-auto'>
								Insights, stories, and updates from the
								Connected team. Discover the latest trends in
											...
											{categories.map((category) => {
												...
												return (
													<Button
														...
														className={`capitalize py-[23px] border transition-colors duration-200 ${
															isSelected
											...
											<div className='md:flex'>
												...
												<div className='md:w-1/2 p-8'>
														...
														dangerouslySetInnerHTML={{
															__html:
																...
																featuredPost
																	...
																	.length >
																	150
																	? featuredPost.excerpt.substring(
																			0,
																			150,
																	  ) + '...'
																	: featuredPost.excerpt,
														}}
														className='text-gray-600 mb-6 text-lg leading-relaxed line-clamp-3 break-words'
													/>
													<div className='flex items-center justify-between'>
														...
														<Button
															asChild
															className='bg-[#6529b2] hover:bg-purple-700 flex-shrink-0'
														>
															<Link
