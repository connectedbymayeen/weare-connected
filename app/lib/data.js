...
export async function getJobBySlug(slug) {
  try {
    ...
    const job = await db.collection("jobs").findOne({
      slug: slug,
      status: { $in: ["open", "closed"] }, // Don't show draft jobs to public
    })
  ...
  return [
    {
      ...
      thumbnailImage: "/placeholder.svg?height=400&width=600&text=Frontend+Developer",
    ...
    },
    {
      ...
      thumbnailImage: "/placeholder.svg?height=400&width=600&text=Backend+Developer",
      department: "Engineering",
    ...
    },
    {
      ...
      thumbnailImage: "/placeholder.svg?height=400&width=600&text=Full+Stack+Developer",
      department: "Engineering",
