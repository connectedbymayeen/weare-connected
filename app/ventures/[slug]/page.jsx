...
import { ArrowLeft, Award, Calendar, ExternalLink, Target, TrendingUp, Users, Zap } from "lucide-react"
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              {venture.website && (
                <Button
                  ...
                  size="lg"
                  asChild
                  className="border-white bg-white  dark:bg-white text-[#6529b2] hover:bg-white hover:text-[#241637] rounded-lg"
                >
                  <a href={venture.website} target="_blank" rel="noopener noreferrer">
                    Visit {venture.name}
                  </a>
