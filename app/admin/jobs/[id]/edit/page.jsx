  ...
  const fetchJob = async () => {
    try {
      ...
      setFormData({
        ...
        applicationFormFields: job.applicationFormFields || DEFAULT_FORM_FIELDS,
      })
    } catch (err) {
        ...
        <Card>
          <CardContent className="p-6">
            <div className="bg-red-50 border border-red-200 text-red-700 px-4 py-3 rounded-md">
              <p>{error}</p>
              <Button variant="outline" className="mt-2 bg-transparent" onClick={() => router.push("/admin/jobs")}>
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center">
          ...
          <div>
            ...
            <p className="text-gray-600 mt-1">Update job listing information and application form</p>
          </div>
        </div>
